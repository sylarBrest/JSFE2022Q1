...
export const renderHeader: RenderFn = (): string => `
  <header class="header">
...
const renderViewSwitch: RenderFn = (): string => `
...
const renderCreateCarContainer: RenderFn = (): string => `
...
const renderWinnerMessage: RenderFn = (): string => `
  <p class="winner-message"></p>
`;

const renderUpdateCarContainer: RenderFn = (): string => `
...
const renderControlButtonsContainer: RenderFn = (): string => `
...
const drawCar: DrawFn = (color: string): string => `
...
const drawFinish: RenderFn = (): string => `
...
const renderTrack: RenderFn = (): string => `
  <div class="track">
    ${storage.garage.reduce((track: string, car: Car) => track + renderCarPath(car), '')}
  </div>
`;

const renderPaginationButtonsContainer: RenderFn = (): string => `
...
export const renderGarageView: RenderFn = (): string => `
...
export const renderWinnersView: RenderFn = (): string => `
...
export const renderFooter: RenderFn = (): string => `
  <footer class="footer">
...
export const renderMain: EmptyPromiseVoidFn = async (): Promise<void> => {
