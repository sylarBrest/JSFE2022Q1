...
export const renderHeader: EmptyStringFn = (): string => `
  <header class="header">
...
const drawFinish: EmptyStringFn = (): string => `
...
export const renderGarage: EmptyStringFn = (): string => `
...
export const renderGarageView: EmptyStringFn = (): string => `
...
export const renderWinnersView: EmptyStringFn = (): string => `
...
export const renderFooter: EmptyStringFn = (): string => `
  <footer class="footer">
